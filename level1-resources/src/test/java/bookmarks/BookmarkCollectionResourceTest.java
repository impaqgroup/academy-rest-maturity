...
@WebAppConfiguration
public class BookmarkCollectionResourceTest {
    ...
    public void readBookmarks() throws Exception {
        mockMvc.perform(post("/" + userName + "/bookmarks/get"))
                .andExpect(status().isOk())
                .andExpect(content().contentType(contentType))
    ...
    public void deleteBookmark() throws Exception{
        mockMvc.perform(post("/" + userName + "/bookmarks/" +this.bookmarkList.get(0).getId() + "/delete"))
                .andExpect(status().isOk());
    }
